...
while (tanya) {
  ...
  if (guess > 6) {
    if (player == generate) {
      hasil = `Selamat anda telah memenangkan permainan ini dengan jumlah tebakan ${guess}`;
      guess = 1;
    ...
    hasil = `Anda telah melampaui batas percobaan permainan ini dengan percobaan ${guess}`;
  }
  alert(hasil);
