...
var tambahPenumpang = function tambahPenumpang(namaPenumpang, penumpang) {
  // Jika angkot kosong
  if (penumpang.length == 0) {
    // Tambah penumpang di awal array
    penumpang.push(namaPenumpang); // Kembalikan isi array & keluar dari function
    ...
    for (var i = 0; i < penumpang.length; i++) {
      ...
      if (penumpang[i] == undefined) {
        ...
        penumpang[i] = namaPenumpang; // kembalikan isi array & keluar dari function

        return penumpang;
      } // Jika sudah ada nama yang sama
      else if (penumpang[i] == namaPenumpang) {
          // Tampilkan pesan kesalahannya
          console.log("".concat(namaPenumpang, " sudah ada di dalam angkot")); // kembalikan isi array & keluar dari function
...
var hapusPenumpang = function hapusPenumpang(namaPenumpang, penumpang) {
  // jika tidak ada penumpang didalam angkot
  if (penumpang.length == 0) {
    console.log("Angkot masih kosong");
    return penumpang;
  ...
  for (var i = 0; i < penumpang.length; i++) {
    ...
    if (namaPenumpang == penumpang[i]) {
      ...
      return penumpang;
        ...
        console.log("".concat(namaPenumpang, " tidak ada di angkot"));
        return penumpang;
      }
  }
};